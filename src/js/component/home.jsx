...
const card = [
	{ image: "https://www.clarin.com/img/2021/10/07/l-IQkhV1S_340x340__1.jpg", title: "Kimchi", description: "Kimchi (in Hangul, 김치; pronounced [kimtɕʰi]) is a Korean dish made from a fermented preparation whose basic ingredient is Asian cabbage. There are also other recipes that use other ingredients.", buttonURL: "https://es.wikipedia.org/wiki/Kimchi", buttonLabel: "Click Here" },
